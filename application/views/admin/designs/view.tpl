                            ...
                            <div class="mdc-layout-grid__cell--span-12-desktop mdc-layout-grid__cell--span-8-tablet mdc-layout-grid__cell--span-4-phone">
                                <div class="mdc-layout-grid">
                                    <div class="mdc-layout-grid__inner">
                                            ...
                                            <div class="params mdc-select" id="kind" role="listbox" data-required="" aria-controls="kind-validation-msg" style="width:100%;">
                                                ...
                                                <div class="mdc-menu mdc-select__menu">
                                                    <ul class="mdc-list mdc-menu__items">
                                                        <li class="mdc-list-item" id="kind-cnc" role="option" tabindex="0" value="cnc">cnc</li>
                                                        <li class="mdc-list-item" id="kind-part" role="option" tabindex="0" value="part">part</li>
                                                        <li class="mdc-list-item" id="kind-sheet_metal" role="option" tabindex="0" value="sheet_metal">sheet_metal</li>
                                                    </ul>
                                                </div>
                                            </div>
                                        ...
                                        <div class="mdc-layout-grid__cell--span-6-desktop mdc-layout-grid__cell--span-8-tablet mdc-layout-grid__cell--span-4-phone">
                                            <div class="mdc-text-field mdc-text-field--fullwidth portal-text-field--fullwidth">
                                                <input class="params mdc-text-field__input" id="background" required="" type="text" aria-controls="background-validation-msg">
                                                <label class="mdc-floating-label" for="background" onclick="_dialogFile.show();">Hình ảnh</label>
                                                <div class="mdc-line-ripple"></div>
                                            </div>
                                            <p class="mdc-text-field-helper-text mdc-text-field-helper-text--persistent mdc-text-field-helper-text--validation-msg" id="background-validation-msg">Click Hình ảnh để tải hoặc vào ô nhập link</p>
