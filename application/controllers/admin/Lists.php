...
class Lists extends MY_Controller {
    ...
    public function intro() {
        ...
        $listJs = array(
            ...
            '/static/admin/js/plugins/dataTables.pipeline.js',
            '/static/admin/js/plugins/buttons.html5.min.js',
            '/static/admin/js/extra/intro.js'
        );
        ...
        $this->parser->parse($this->viewPath."intro", $data);
    }
    ...
    public function design() {
        ...
        $listJs = array(
            ...
            '/static/admin/js/plugins/dataTables.pipeline.js',
            '/static/admin/js/plugins/buttons.html5.min.js',
            '/static/admin/js/extra/design.js'
        );
        ...
        $this->parser->parse($this->viewPath."design", $data);
    }
...
//        $permission = $this->check_permission($this->class, 'view');
    ...
    function criteria(&$query){
        ...
        $kind = $this->input->post('kind', true);/*kind*/
        ...
        if(!empty($kind)){
            $query = $query->like('kind', $kind, 'both');
        }
        if(!empty($i)){
