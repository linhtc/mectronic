...
<head>
    ...
    <link href="/static/frontend/css/fuma.style.css?v=1.0.3" rel="stylesheet">
</head>
        ...
        <div id="logo" class="pull-left">
            <h1>
                <a href="{base_url()}" class="scrollto">
                    <img src="{base_url()}media/filemanager/{$this->session->userdata('sys_cnf')->cnf_logo->v1}" />
                </a>
            </h1>
        </div>
        <nav id="nav-menu-container">
            <ul class="nav-menu">
                ...
                <li><a href="#portfolio">{lang('thiet ke')}</a>
                    <ul>
                        <li><a href="#web">{lang('san pham cnc')}</a></li>
                        <li><a href="#web">{lang('san pham khuon')}</a></li>
                        <li><a href="#web">{lang('sheet metal')}</a></li>
                    </ul>
                </li>
                <li><a href="#technology">{lang('cong nghe')}</a></li>
                <li><a href="javascript:void(0);">{lang('tuyen dung')}</a></li>
...
<main id="main">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 box wow bounceInUp" data-wow-duration="0.{$duration}s">
                    ...
                    <h4 class="title">
                        <a href="javascript:void(0);" onclick="$('#portfolio-filters li:nth-child({$i+1})').click();">{lang($service->title)}</a>
                    </h4>
                            ...
                            <div class="col-lg-4 col-md-6 portfolio-item filter-{$design->kind} wow fadeInUp" data-wow-delay="0.1s">
                                <div class="portfolio-wrap">
                                    <figure>
                                        ...
                                        -->
                                        <a href="javascript:void(0);" onclick="showDes(this);" class="link-details" title="{lang('chi tiet')}"><i class="ion ion-android-open"></i></a>
                                        <textarea class="hidden-all">{lang($design->sub)}</textarea>
                                    </figure>
    ...
    {if !empty($technologies)}
        <section id="technology"  class="section-bg" >
            <div class="container">
                <header class="section-header">
                    <h3 class="section-title">{lang('cong nghe')}</h3>
                </header>
                ...
                <div class="row technology-container">
                    {foreach from=$technologies key=i item=design}
                        <div class="col-lg-4 col-md-6 portfolio-item filter-{$design->kind} wow fadeInUp" data-wow-delay="0.1s">
                            <div class="portfolio-wrap">
                                <figure>
                                    {if $design->background|strpos:"youtube"}
                                        <iframe style="width: 100%; height: 100%;" class="img-fluid" src="{$design->background}" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                                    {else}
                                    <img src="{$design->background}" class="img-fluid" alt="{lang($design->title)}" title="{lang($design->title)}">
                                    <a href="{$design->background}" class="link-preview" data-lightbox="technology" data-title="{lang($design->title)}" title="{lang('xem')}">
                                        <i class="ion ion-eye"></i>
                                    </a>
                                    <a href="javascript:void(0);" onclick="showDes(this);" class="link-details" title="{lang('chi tiet')}"><i class="ion ion-android-open"></i></a>
                                    <textarea class="hidden-all">{lang($design->sub)}</textarea>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-6 footer-info">
                    <a href="{base_url()}"><img src="{base_url()}media/filemanager/{$this->session->userdata('sys_cnf')->cnf_logo->v1}" /></a>
                    <p>{$this->session->userdata('sys_cnf')->cnf_logo->v2}</p>
                </div>
...
<div class="fb-chat-popup">
    ...
    <div class="fb-page-header">LIÊN HỆ VỚI CHÚNG TÔI ! <img
                src="https://cdn2.iconfinder.com/data/icons/arrows-free/32/nav_arrow_point_down-16.png" alt=""/></div>

    <div class="fb-page-box">
        <div class="fb-page" data-href="https://www.facebook.com/firefuma.vn/" data-height="350" data-width="300"
...
<!-----Kết thúc chát fanpage --->

<script>
    function showDes(that){
        var des = $(that).parent().find('textarea').html();
        console.log(des);
        $('#modal-body').html(des);
...
<script src="/static/frontend/js/fuma.main.js?v=1.0.3"></script>
